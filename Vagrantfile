...
sudo R -e "install.packages('leaflet', repos = 'http://cran.rstudio.com/', dep = TRUE)"
sudo R -e "install.packages('shinydashboard', repos = 'http://cran.rstudio.com/', dep = TRUE)"
sudo R -e "install.packages('DT', repos = 'http://cran.rstudio.com/', dep = TRUE)"
sudo R -e "install.packages('ggmap', repos = 'http://cran.rstudio.com/', dep = TRUE)"
